...
const Login = () => {
  ...
  const userDB = (user) => {
    fetch(`https://mobile-resell-wizards-server.vercel.app/users`, {
      ...
      .then((res) => res.json())
      .then((data) => setLoginUserEmail(user.email));
  };
  return (
    <div className="card bg-base-100 shadow-xl my-20 lg:w-2/5 w-5/6 mx-auto">
      <div className="items-center text-center p-10">
        ...
        <button
          ...
          className="btn btn-primary text-white hover:bg-[#d44040] w-3/4 mx-auto my-4"
        >
          <BsGoogle className="mr-2"></BsGoogle>Log in With Google
        </button>
        ...
        <form onSubmit={handleLoginSubmit}>
          ...
          <div className="form-control mt-6">
            <button
              type="submit"
              className="text-white border-0 btn btn-primary bg-[#D44040] font-semibold"
            >
              Login
            </button>
          </div>
